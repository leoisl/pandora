...
ExternalProject_Add(gatb
        ...
        CONFIGURE_COMMAND ""
        BUILD_COMMAND     bash -c "cd ${GATB_BUILD_DIR} && cmake -D CMAKE_BUILD_TYPE=Release -D CMAKE_C_COMPILER=${CMAKE_C_COMPILER} -D CMAKE_CXX_COMPILER=${CMAKE_CXX_COMPILER} ${GATB_DIR} && make"
        INSTALL_COMMAND   ""
        TEST_COMMAND      "")
